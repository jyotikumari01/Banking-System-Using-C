...
#define rotate_left(l, len) rotate(l.begin(), l.begin() + len, l.end())
#define rotate_right(r, len) rotate(r.begin(), r.begin() + r.size() - len, r.end())
using namespace std;
...
int main()
{
    ...
    float balance;
    float amount;
    string head = "                                                        Welcome to My Banking System                         ";
    moving(head);
    do
    {
        changeColor(05);
